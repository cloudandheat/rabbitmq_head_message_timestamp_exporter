...
if __name__ == "__main__":
    ...
    #                     )
    parser.add_argument("--mq-host", "-m", dest="mq_host", default="localhost")
    parser.add_argument(
        "--exporter-port", "-e", dest="exporter_port", type=int, default="8000"
    )
    parser.add_argument("--queue", "-q", dest="queue", default="event.sample")
    parser.add_argument("--user", "-u", dest="user", default="stackrabbit")
    parser.add_argument("--pass", "-p", dest="password", default="secret")
